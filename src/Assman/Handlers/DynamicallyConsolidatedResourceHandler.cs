...
{
	internal class DynamicallyConsolidatedResourceHandler : ResourceHandlerBase
	{
	    ...
	    public DynamicallyConsolidatedResourceHandler(string path, ResourceCompiler compiler, GroupTemplateContext groupTemplateContext)
		{
			_path = path;
			_compiler = compiler;
		...
		protected override IHandlerResource GetResource()
		{
			...
			return new DynamicallyConsolidatedHandlerResource(consolidatedResource, Mode, MinLastModified, _groupTemplateContext.ResourceType);
		}
